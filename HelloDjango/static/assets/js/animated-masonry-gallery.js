...
$("#filter-1").click(function() {  $container.isotope({ filter: '.1' }); button = 2; check_button();  });
$("#filter-2").click(function() {  $container.isotope({ filter: '.2' }); button = 3; check_button();  });
$("#filter-3").click(function() {  $container.isotope({ filter: '.3' }); button = 4; check_button();  });
$("#filter-4").click(function() {  $container.isotope({ filter: '.4' }); button = 5; check_button();  });
$("#filter-5").click(function() {  $container.isotope({ filter: '.5' }); button = 6; check_button();  });
$("#filter-6").click(function() {  $container.isotope({ filter: '.6' }); button = 7; check_button();  });
$("#filter-7").click(function() {  $container.isotope({ filter: '.7' }); button = 8; check_button();  });
$("#filter-8").click(function() {  $container.isotope({ filter: '.8' }); button = 9; check_button();  });
$("#filter-9").click(function() {  $container.isotope({ filter: '.9' }); button = 10; check_button();  });
$("#filter-10").click(function() {  $container.isotope({ filter: '.10' }); button = 11; check_button();  });
